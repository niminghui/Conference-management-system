...
public class Employee {
	...
	public Employee(String employeeName, String employeeNickname, String employeeGender, String positionId,
			String departmentId, String employeeStatus, String employeeCompany,
			String employeeUpdatedUser, String employeeCreatedUser) {
		super();
		this.employeeName = employeeName;
		this.employeeNickname = employeeNickname;
		this.employeeGender = employeeGender;
