...
//		final String password = "yyoutj00"; // 发件人的邮件密码
		...
		try {
			...
			message.addRecipients(Message.RecipientType.TO, InternetAddress.parse(to.toString()));*/
			...
			message.setContent("<span style='color:red;margin:0 auto'>"+content+"</span>", "text/html;charset=utf-8");
	...
	public static void main(String[] args) {
		...
		String content="hello, Rainson, ziqiang, this is the third email,"   //邮件内容
				+ "  please send me the report of RPPUAT and the signoff"
				+ "  best regards."
				+ "  Yu.You.";
